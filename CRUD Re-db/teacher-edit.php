...
<head>
    ...
    <title>Edit and Update data into database using PHP PDO Re-db</title>
            ...
            <div class="col-md-12 mt-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>Edit and Update data into database using PHP PDO Re-db
                    ...
                    <div class="card-body">
                        <?php 
                            if(isset($_GET['id'])){
                                ...
                                $query = "SELECT * FROM teachers WHERE id=:teacher_id LIMIT 1";
                    ...
                    <form action="code.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="gender" value="<?= $result['gender']; ?>" class="form-control" />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="education_level" value="<?= $result['education_level']; ?>" class="form-control" />
                        </div>
                        <div class="mb-3">
